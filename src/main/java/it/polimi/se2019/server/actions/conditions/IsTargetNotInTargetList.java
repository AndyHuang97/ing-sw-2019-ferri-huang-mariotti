...
public class IsTargetNotInTargetList implements Condition {
    ...
    public boolean check(Game game, Map<String, List<Targetable>> targets) {
        Targetable targetPlayer = targets.get(ConditionConstants.TARGET).get(PLAYERPOSITION);
        List<Targetable> cumulativeTargetList = targets.get(ConditionConstants.CUMULATIVETARGETLIST);
